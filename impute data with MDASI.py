...
df_final["mdasi_score_all_baseline"] = df_final["mdasi_appetite_baseline"] + df_final["mdasi_choke_baseline"] + df_final["mdasi_constipation_baseline"] + \
df_final["mdasi_distress_baseline"] + df_final["mdasi_drowsy_baseline"] + df_final["mdasi_drymouth_baseline"] + df_final["mdasi_fatigue_baseline"] + \
df_final["mdasi_memory_baseline"] + df_final["mdasi_mucositis_baseline"] + df_final["mdasi_mucus_baseline"] + df_final["mdasi_nausea_baseline"] + \
df_final["mdasi_numb_baseline"] + df_final["mdasi_pain_baseline"] + df_final["mdasi_sad_baseline"] + df_final["mdasi_skin_baseline"] + \
df_final["mdasi_sleep_baseline"] + df_final["mdasi_sob_baseline"] + df_final["mdasi_swallow_baseline"] + df_final["mdasi_taste_baseline"] + \
df_final["mdasi_teeth_baseline"] + df_final["mdasi_voice_baseline"] + df_final["mdasi_vomit_baseline"]
df_final["mdasi_score_all_baseline"] = df_final["mdasi_score_all_baseline"] / 22

df_final["mdasi_score_all_end_of_xrt"] = df_final["mdasi_appetite_end_of_xrt"] + df_final["mdasi_choke_end_of_xrt"] + df_final["mdasi_constipation_end_of_xrt"] + \
df_final["mdasi_distress_end_of_xrt"] + df_final["mdasi_drowsy_end_of_xrt"] + df_final["mdasi_drymouth_end_of_xrt"] + df_final["mdasi_fatigue_end_of_xrt"] + \
df_final["mdasi_memory_end_of_xrt"] + df_final["mdasi_mucositis_end_of_xrt"] + df_final["mdasi_mucus_end_of_xrt"] + df_final["mdasi_nausea_end_of_xrt"] + \
df_final["mdasi_numb_end_of_xrt"] + df_final["mdasi_pain_end_of_xrt"] + df_final["mdasi_sad_end_of_xrt"] + df_final["mdasi_skin_end_of_xrt"] + \
df_final["mdasi_sleep_end_of_xrt"] + df_final["mdasi_sob_end_of_xrt"] + df_final["mdasi_swallow_end_of_xrt"] + df_final["mdasi_taste_end_of_xrt"] + \
df_final["mdasi_teeth_end_of_xrt"] + df_final["mdasi_voice_end_of_xrt"] + df_final["mdasi_vomit_end_of_xrt"]
df_final["mdasi_score_all_end_of_xrt"] = df_final["mdasi_score_all_end_of_xrt"] / 22

df_final["mdasi_score_all_start_of_xrt"] = df_final["mdasi_appetite_start_of_xrt"] + df_final["mdasi_choke_start_of_xrt"] + df_final["mdasi_constipation_start_of_xrt"] + \
df_final["mdasi_distress_start_of_xrt"] + df_final["mdasi_drowsy_start_of_xrt"] + df_final["mdasi_drymouth_start_of_xrt"] + df_final["mdasi_fatigue_start_of_xrt"] + \
df_final["mdasi_memory_start_of_xrt"] + df_final["mdasi_mucositis_start_of_xrt"] + df_final["mdasi_mucus_start_of_xrt"] + df_final["mdasi_nausea_start_of_xrt"] + \
df_final["mdasi_numb_start_of_xrt"] + df_final["mdasi_pain_start_of_xrt"] + df_final["mdasi_sad_start_of_xrt"] + df_final["mdasi_skin_start_of_xrt"] + \
df_final["mdasi_sleep_start_of_xrt"] + df_final["mdasi_sob_start_of_xrt"] + df_final["mdasi_swallow_start_of_xrt"] + df_final["mdasi_taste_start_of_xrt"] + \
df_final["mdasi_teeth_start_of_xrt"] + df_final["mdasi_voice_start_of_xrt"] + df_final["mdasi_vomit_start_of_xrt"]
df_final["mdasi_score_all_start_of_xrt"] = df_final["mdasi_score_all_start_of_xrt"] / 22

df_final["mdasi_score_all_week_2"] = df_final["mdasi_appetite_week_2"] + df_final["mdasi_choke_week_2"] + df_final["mdasi_constipation_week_2"] + \
df_final["mdasi_distress_week_2"] + df_final["mdasi_drowsy_week_2"] + df_final["mdasi_drymouth_week_2"] + df_final["mdasi_fatigue_week_2"] + \
df_final["mdasi_memory_week_2"] + df_final["mdasi_mucositis_week_2"] + df_final["mdasi_mucus_week_2"] + df_final["mdasi_nausea_week_2"] + \
df_final["mdasi_numb_week_2"] + df_final["mdasi_pain_week_2"] + df_final["mdasi_sad_week_2"] + df_final["mdasi_skin_week_2"] + \
df_final["mdasi_sleep_week_2"] + df_final["mdasi_sob_week_2"] + df_final["mdasi_swallow_week_2"] + df_final["mdasi_taste_week_2"] + \
df_final["mdasi_teeth_week_2"] + df_final["mdasi_voice_week_2"] + df_final["mdasi_vomit_week_2"]
df_final["mdasi_score_all_week_2"] = df_final["mdasi_score_all_week_2"] / 22

df_final["mdasi_score_all_week_3"] = df_final["mdasi_appetite_week_3"] + df_final["mdasi_choke_week_3"] + df_final["mdasi_constipation_week_3"] + \
df_final["mdasi_distress_week_3"] + df_final["mdasi_drowsy_week_3"] + df_final["mdasi_drymouth_week_3"] + df_final["mdasi_fatigue_week_3"] + \
df_final["mdasi_memory_week_3"] + df_final["mdasi_mucositis_week_3"] + df_final["mdasi_mucus_week_3"] + df_final["mdasi_nausea_week_3"] + \
df_final["mdasi_numb_week_3"] + df_final["mdasi_pain_week_3"] + df_final["mdasi_sad_week_3"] + df_final["mdasi_skin_week_3"] + \
df_final["mdasi_sleep_week_3"] + df_final["mdasi_sob_week_3"] + df_final["mdasi_swallow_week_3"] + df_final["mdasi_taste_week_3"] + \
df_final["mdasi_teeth_week_3"] + df_final["mdasi_voice_week_3"] + df_final["mdasi_vomit_week_3"]
df_final["mdasi_score_all_week_3"] = df_final["mdasi_score_all_week_3"] / 22

df_final["mdasi_score_all_week_4"] = df_final["mdasi_appetite_week_4"] + df_final["mdasi_choke_week_4"] + df_final["mdasi_constipation_week_4"] + \
df_final["mdasi_distress_week_4"] + df_final["mdasi_drowsy_week_4"] + df_final["mdasi_drymouth_week_4"] + df_final["mdasi_fatigue_week_4"] + \
df_final["mdasi_memory_week_4"] + df_final["mdasi_mucositis_week_4"] + df_final["mdasi_mucus_week_4"] + df_final["mdasi_nausea_week_4"] + \
df_final["mdasi_numb_week_4"] + df_final["mdasi_pain_week_4"] + df_final["mdasi_sad_week_4"] + df_final["mdasi_skin_week_4"] + \
df_final["mdasi_sleep_week_4"] + df_final["mdasi_sob_week_4"] + df_final["mdasi_swallow_week_4"] + df_final["mdasi_taste_week_4"] + \
df_final["mdasi_teeth_week_4"] + df_final["mdasi_voice_week_4"] + df_final["mdasi_vomit_week_4"]
df_final["mdasi_score_all_week_4"] = df_final["mdasi_score_all_week_4"] / 22

df_final["mdasi_score_all_week_5"] = df_final["mdasi_appetite_week_5"] + df_final["mdasi_choke_week_5"] + df_final["mdasi_constipation_week_5"] + \
df_final["mdasi_distress_week_5"] + df_final["mdasi_drowsy_week_5"] + df_final["mdasi_drymouth_week_5"] + df_final["mdasi_fatigue_week_5"] + \
df_final["mdasi_memory_week_5"] + df_final["mdasi_mucositis_week_5"] + df_final["mdasi_mucus_week_5"] + df_final["mdasi_nausea_week_5"] + \
df_final["mdasi_numb_week_5"] + df_final["mdasi_pain_week_5"] + df_final["mdasi_sad_week_5"] + df_final["mdasi_skin_week_5"] + \
df_final["mdasi_sleep_week_5"] + df_final["mdasi_sob_week_5"] + df_final["mdasi_swallow_week_5"] + df_final["mdasi_taste_week_5"] + \
df_final["mdasi_teeth_week_5"] + df_final["mdasi_voice_week_5"] + df_final["mdasi_vomit_week_5"]
df_final["mdasi_score_all_week_5"] = df_final["mdasi_score_all_week_5"] / 22

df_final["mdasi_score_all_week_6"] = df_final["mdasi_appetite_week_6"] + df_final["mdasi_choke_week_6"] + df_final["mdasi_constipation_week_6"] + \
df_final["mdasi_distress_week_6"] + df_final["mdasi_drowsy_week_6"] + df_final["mdasi_drymouth_week_6"] + df_final["mdasi_fatigue_week_6"] + \
df_final["mdasi_memory_week_6"] + df_final["mdasi_mucositis_week_6"] + df_final["mdasi_mucus_week_6"] + df_final["mdasi_nausea_week_6"] + \
df_final["mdasi_numb_week_6"] + df_final["mdasi_pain_week_6"] + df_final["mdasi_sad_week_6"] + df_final["mdasi_skin_week_6"] + \
df_final["mdasi_sleep_week_6"] + df_final["mdasi_sob_week_6"] + df_final["mdasi_swallow_week_6"] + df_final["mdasi_taste_week_6"] + \
df_final["mdasi_teeth_week_6"] + df_final["mdasi_voice_week_6"] + df_final["mdasi_vomit_week_6"]
df_final["mdasi_score_all_week_6"] = df_final["mdasi_score_all_week_6"] / 22
...
df_final.to_excel(f"MDASI test imputed {method} {rows_dropped} dropped.xlsx", index=False, float_format="%.4f", sheet_name="MDASI scores")
